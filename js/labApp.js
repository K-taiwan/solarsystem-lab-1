...
solarSystem[2].diameter = 'earth miles';
...
const solarSystemChecker = (obj) => {
    for(let key in obj){
        if(obj[key].ringSystem === true){
            console.log(obj[key].name);
        }
    }
}
solarSystemChecker(solarSystem);
...
console.log(parseFloat(system.Jupiter.satellites));
console.log(system.Saturn.satellites);
console.log(system.Uranus.satellites);
console.log(system.Neptune.satellites);

const sum = parseFloat(system.Jupiter.satellites) + system.Saturn.satellites +system.Uranus.satellites+system.Neptune.satellites;
console.log(sum);
...
// momentum(system.Jupiter.mass,system.Jupiter.velocity);
console.log(parseFloat(momentum(system.Jupiter.mass, system.Jupiter.velocity)));
console.log(parseFloat(momentum(system.Pluto.mass,system.Pluto.velocity)));
console.log(parseFloat(momentum(system.Jupiter.mass, system.Jupiter.velocity))-parseFloat(momentum(system.Pluto.mass,system.Pluto.velocity)));



// pJupiter = system.Jupiter.mass * system.Jupiter.velocity;
// pPluto = system.Pluto.mass *system.Pluto.velocity;
// console.log(pJupiter);
// console.log(pPluto);
// difference = pJupiter - pPluto;
...
// Hungry for more?
// A. Weather Lab
// Complete this advanced object lab, which uses weather forecast data.
